...
const dedicatedServerPath = "C:/minecraft/servers/bdsx/bedrock_server/development_behavior_packs/"; // if using Bedrock Dedicated Server, where to find the extracted contents of the zip package
...
function watch() {
  return gulp.watch(
    ["src/**/*.ts", "behavior_packs/**/*", "resource_packs/**/*"],
